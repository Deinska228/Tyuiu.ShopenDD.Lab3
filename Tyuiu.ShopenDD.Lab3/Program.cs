...
namespace Tyuiu.ShopenDD.Lab3
{
    class Program
    {
        ...
        static void OptionFS()
        {
            ...
            Console.WriteLine(" Программу разработал ШОПЕН ДЕНИС ДМИТРИЕВИЧ | МКМб-22-1 | ТИУ 2024");
            Console.SetCursorPosition(0, 22);
            Console.WriteLine("------------------------------------------------------------------------------");
        ...
        static void drawMainMenu()
        {
            ...
            Console.WriteLine("║                        Выполнил Шопен Денис Дмитриевич                    ║");
